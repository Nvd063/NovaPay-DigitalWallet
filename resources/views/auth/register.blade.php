        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="field-grp">
                ...
                <div class="field-wrap">
                    ...
                    <input type="text" name="full_name" placeholder="Ahmed Ali" required value="{{ old('full_name') }}"
                        autocomplete="off" />
                </div>
            </div>
            <div class="field-grp">
            ...
            <br>
            <div class="auth-flip" style="margin-top: 20px; text-align: center;">
                <p>Already have an account? <a href="{{ route('login') }}"
                        style="color: var(--accent); font-weight: 600;">Sign In</a></p>
            </div>
        </form>
